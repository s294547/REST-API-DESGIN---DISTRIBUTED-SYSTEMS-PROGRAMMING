...
app.get('/api/films/public/:filmId/reviews/single', reviewController.getSingleFilmReviews);
app.get('/api/films/public/:filmId/reviews/single/:reviewerId', reviewController.getSingleReview);
app.get('/api/films/public/:filmId/reviews/cooperative', reviewController.getCooperativeFilmReviews);
app.get('/api/films/public/:filmId/reviews/cooperative/:reviewersId', reviewController.getCooperativeReview);
app.get('/api/films/public/:filmId/reviews/:reviewersId', reviewController.getReview);
app.delete('/api/films/public/:filmId/reviews/:reviewersId', isLoggedIn, reviewController.deleteReview);
app.put('/api/films/public/:filmId/reviews/single/:reviewerId', isLoggedIn, validate({ body: reviewSchema }), reviewController.updateSingleReview);
app.get('/api/films/public/:filmId/reviews/cooperative/:reviewersId/drafts', draftController.getCooperativeReviewDrafts);
app.post('/api/films/public/:filmId/reviews/cooperative/:reviewersId/drafts', isLoggedIn, validate({ body: draftSchema }), draftController.addCooperativeReviewDraft);
app.get('/api/films/public/:filmId/reviews/cooperative/:reviewersId/drafts/:draftId', draftController.getCooperativeReviewDraft);
app.delete('/api/films/public/:filmId/reviews/cooperative/:reviewersId/drafts/:draftId', isLoggedIn, draftController.deleteCooperativeReviewDraft);
app.post('/api/films/public/:filmId/reviews/cooperative/:reviewersId/drafts/:draftId/agreements', isLoggedIn, validate({ body: agreementSchema }), agreementController.addAgreement);
app.get('/api/films/public/:filmId/reviews/cooperative/:reviewersId/drafts/:draftId/agreements', agreementController.getAgreements);
app.get('/api/films/public/:filmId/reviews/cooperative/:reviewersId/drafts/:draftId/agreements/:authorId', agreementController.getAgreement);
app.delete('/api/films/public/:filmId/reviews/cooperative/:reviewersId/drafts/:draftId/agreements/:authorId', isLoggedIn, agreementController.deleteAgreement);
